...
import com.simpletouch.auntieannesdelivery.view.utils.LocationUtils;
...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "com.simpletouch.auntieannesdelivery.view.view.features";
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.layer_594_copy_2, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.ic_lock, getString(R.string.remove_location_updates),
